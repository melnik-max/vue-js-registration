...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-10">
            ...
            <form-container class="js-form" id="register-form">

                <form-group type="text" name="first_name" maxlength="45" placeholder="Enter first name" label="First name (*):"></form-group>

                <form-group type="text" name="last_name" maxlength="45" placeholder="Enter last name" label="Last name (*):"></form-group>

                <form-group type="text" name="birth_date" placeholder="Enter date of birth" label="Birth date (*):"></form-group>

                <form-group type="text" maxlength="200" name="report_subject" placeholder="Enter report subject" label="Report subject (*):"></form-group>
                ...
                <form-group type="text" maxlength="18" name="phone" placeholder="+X (XXX) XXX XXXX" label="Phone number (*): "></form-group>

                <form-group type="email" maxlength="45" name="email" placeholder="Enter email" label="Email (*):"></form-group>
